...
script_name <- paste0("ptime_subset_homeo_seurat3_v1.0")
...
if (FALSE) {
  testPCs(seurat_obj, from_to = 16:25, include_conditions = TRUE)
}
...
if(FALSE) {
  source(paste0("/n/projects/ddiaz/Analysis/Scripts/sb2191-regen/",
    "Seurat3-final/ptime_subset_homeo_seurat3_v1.0_.R"), echo = TRUE)
}
