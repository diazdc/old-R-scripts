...
script_name <- paste0("ptime_subset_homeo_seurat3_irg1l_v1.0")
...
seurat_obj <- seurat_obj[,seurat_obj@meta.data$tree.ident != 2]
...
if(FALSE) {
  source(paste0("/n/projects/ddiaz/Analysis/Scripts/sb2191-regen/",
    "Seurat3-final/ptime_subset_homeo_seurat3_irg1l_v1.0_.R"), echo = TRUE)
}
